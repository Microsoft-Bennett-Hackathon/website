...
//   return (
//     <>
//       <div className="dashboard-home-container flex flex-col p-[40px] overflow-">
...
//               />
//               <div className="ml-[15px] flex flex-col ga mb-[30px]p-2">
...
//               {/* Monday */}
//               <div
//                 className="flex flex-col items-center border-r w-1/6 border-gray-500 px-[10px]"
...
//               </div>
//               {/* Tuesday */}
//               <div className="flex flex-col items-center border-r w-1/6 border-gray-500 px-[10px]">
