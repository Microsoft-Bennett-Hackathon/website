...
// const Dietplan = () => {
//   return (
//     <div className="overflow-y-scroll h-[90vh] p-4">
//       <h1>Gym Athlete's Diet Plan</h1>
//       <p>
...
//       <h2>Meal 1: Breakfast</h2>
//       <p>
//         <strong>Meal Type:</strong> High-protein, moderate carbs, healthy fats
//       </p>
//       <ul>
...
//       <h2>Meal 2: Mid-Morning Snack</h2>
//       <p>
...
//       <h2>Meal 4: Pre-Workout Snack</h2>
//       <p>
...
//       <h2>Meal 5: Post-Workout Meal</h2>
//       <p>
...
//       <h2>Meal 7: Evening Snack</h2>
//       <p>
//         <strong>Meal Type:</strong> Light protein, healthy fats
//       </p>
//       <ul>
//         <li>Cottage cheese (1 cup) or Greek yogurt (protein and probiotics)</li>
...
//         (e.g., cutting or bulking), activity level, and body composition. Always
//         consult with a nutritionist or dietitian to ensure the plan meets your
//         specific needs.
//       </p>
//     </div>
//   );
